...
<html lang="en" class="no-js">
  <head>
    ...
    <title>Matt Knott</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    <meta name="description" content="MattKnott.com" />
    <meta name="keywords" content="portfolio" />
    <meta name="author" content="Matthew Knott 2022" />
      ...
      <div id="page_container" class="page-container bg-move-effect" data-animation="transition-flip-in-right">
          ...
          <div class="header-content clearfix">
            ...
            <div class="text-logo">
              <a href="index.html">
                ...
                <div class="logo-text">Matt <span>Knott</span></div>
              </a>
            </div>
            <!-- /Text Logo -->
                      ...
                      <div class="row flex-v-align">
                        ...
                        <div class="col-sm-12 col-md-7 col-lg-7">
                          <div class="home-text hp-left">
                            ...
                            <h1>Matt Knott</h1>
                            <p>This is just a simple page I've set up to introduce myself and save people trying to sneak onto LinkedIn to look at what I've done.</p>
                ...
                <div class="row">
                    ...
                    <div class="info-list-w-icon">
                      <div class="info-block-w-icon">
                        ...
                        <div class="ci-text">
                          ...
                          <p>I've written Beginning Xcode, a straight forward guide to getting started writing native iOS apps using the Xcode IDE. Beginning Xcode is available from Amazon and is published by Apress.</p>
                        </div>
                      </div>
                  ...
                  <div class="col-xs-12 col-sm-6">
                    <div class="info-list-w-icon">
                      ...
                      <div class="info-block-w-icon">
                        <div class="ci-icon">
                          <i class="linecons linecons-study"></i>
                        </div>

                        <div class="ci-text">
                          <h4>Certifications</h4>
                          <p>I'm a certified Enterprise Architect (Togaf 9.2), Scrum Product Owner, and SAFe 5 practitioner. I've earner a level 4 certifiacte in leadership from ILM, and a level 5 certificate from CMI.</p>
                        </div>
                      </div>
        ...
        <footer class="site-footer clearfix">
          ...
          <div class="footer-copyrights">
            <p>© 2022 All rights reserved. Matthew Knott.</p>
          </div>
        </footer>
        <!-- /Footer -->
